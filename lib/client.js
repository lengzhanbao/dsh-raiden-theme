window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		//#endregion
		//#region ../../src/deepseek-harness-bak-20260910/vendor/schemastery/node_modules/@deepseek-ai/cosmokit/lib/index.js
		...
		//#endregion
		//#region ../../src/deepseek-harness-bak-20260910/vendor/schemastery/lib/index.mjs
		...
		const colorPreset = Schema.union([
			Schema.const("raiden-violet"),
			Schema.const("raiden-night"),
			Schema.const("raiden-sakura"),
			Schema.const("custom")
		...
		const RaidenColorConfigSchema = Schema.object({
			preset: colorPreset,
		...
		const RaidenSettingsSchema = Schema.object({
			schemaVersion: Schema.number().default(4),
			enabled: Schema.boolean().default(false),
			displayName: Schema.string().default("雷电将军"),
			subtitle: Schema.string().default("尘世七执政 · 永恒"),
			heroHeadline: Schema.string().default("原神！！！启动！！！"),
			...
			veilOpacity: Schema.number().min(0).max(100).default(6),
			acrylicPercent: Schema.number().min(0).max(100).default(38),
			frameOpacity: Schema.number().min(0).max(100).default(42),
			panelOpacity: Schema.number().min(0).max(100).default(42),
			...
			showMascot: Schema.boolean().default(false),
			showWorkspaceMascot: Schema.boolean().default(true),
		...
		const tokensCss = "/* Raiden tokens live on body. Official --dsw-* stay on native DSH panes only. */\n\nbody[data-dsh-raiden-theme] {\n  --ds-raiden-cream: #f4eefc;\n  --ds-raiden-cream-deep: #e4d6f8;\n  --ds-raiden-pink: #a78bfa;\n  --ds-raiden-pink-soft: #ddd6fe;\n  --ds-raiden-gold: #e7b957;\n  --ds-raiden-gold-deep: #c9a227;\n  --ds-raiden-charcoal: #3d2a52;\n  --ds-raiden-ribbon: #c43c3c;\n  --ds-raiden-lens: #c4b5fd;\n  --ds-raiden-lavender: #b9a7e8;\n  --ds-raiden-text: #1a1024;\n  --ds-raiden-text-on-dark: #f4edff;\n  --raiden-text-halo:\n    0 0 0.6px rgba(255, 255, 255, 0.9),\n    0 1px 0 rgba(244, 238, 252, 0.9),\n    0 0 8px rgba(167, 139, 250, 0.35);\n  --ds-raiden-border: rgba(91, 54, 140, 0.16);\n  --raiden-q-face: none;\n  --raiden-q-send: none;\n  --raiden-q-settings: none;\n  --raiden-q-brand: none;\n  --raiden-q-brand-right: none;\n  --raiden-q-new: none;\n  --raiden-q-command: none;\n  --raiden-q-stop: none;\n  --raiden-veil-strength: 0.06;\n\n  --ds-agent-idle: var(--ds-raiden-pink);\n  --ds-agent-thinking: var(--ds-raiden-lavender);\n  --ds-agent-tool: var(--ds-raiden-lens);\n  --ds-agent-streaming: var(--ds-raiden-pink-soft);\n  --ds-agent-success: var(--ds-raiden-gold);\n  --ds-agent-error: var(--ds-raiden-ribbon);\n\n  --raiden-sidebar-width: 280px;\n  --raiden-accent: var(--ds-raiden-pink);\n  --raiden-glow: rgba(167, 139, 250, 0.32);\n  --raiden-hairline: color-mix(in srgb, var(--ds-raiden-pink) 35%, transparent);\n  --raiden-motion-scale: 1;\n  --raiden-motion-duration: 1;\n  --raiden-veil: var(--ds-raiden-cream);\n  --raiden-font: \"M PLUS Rounded 1c\", Nunito, Inter, \"Segoe UI\", \"Noto Sans SC\", \"PingFang SC\", system-ui, sans-serif;\n  --raiden-mono: \"JetBrains Mono\", ui-monospace, \"Cascadia Mono\", Consolas, monospace;\n  --raiden-pink: var(--ds-raiden-pink);\n  --raiden-pink-deep: #6d28d9;\n  --raiden-ink: var(--ds-raiden-text);\n  --raiden-muted: #6b5a82;\n  --raiden-blue: var(--ds-raiden-lens);\n  --raiden-radius-sm: 8px;\n  --raiden-radius-md: 12px;\n  --raiden-radius-lg: 16px;\n  --raiden-frame-inset: 8px;\n  --raiden-frame-opacity: 0.42;\n  --raiden-panel-opacity: 42;\n  --raiden-plate-art: linear-gradient(\n    90deg,\n    rgba(167, 139, 250, 0.38),\n    rgba(244, 238, 252, 0.28) 50%,\n    rgba(124, 58, 237, 0.28)\n  );\n  --raiden-settings-frame-art: var(--raiden-plate-art);\n  /* Violet-gold filigree (SVG) — electro dust, no huge border-image grow */\n  --raiden-gold-corner-art: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2264%22%20height=%2264%22%20viewBox=%220%200%2064%2064%22%20fill=%22none%22%3E%3Cpath%20d=%22M8%2054V14c0-5%204-9%209-9h38%22%20stroke=%22%23efb07a%22%20stroke-width=%222%22%20stroke-linecap=%22round%22/%3E%20%3Cpath%20d=%22M8%2054V20%22%20stroke=%22%23a78bfa%22%20stroke-width=%221.15%22%20opacity=%220.85%22/%3E%20%3Cpath%20d=%22M18%2020c7-9%2016-12%2028-8%22%20stroke=%22%23efd9a0%22%20stroke-width=%221.25%22%20opacity=%220.95%22/%3E%20%3Cpath%20d=%22M16%2028c4-8%2011-11%2020-8%22%20stroke=%22%23c4b5fd%22%20stroke-width=%221%22%20opacity=%220.8%22/%3E%20%3Cpath%20d=%22M14%2036c3-3%206-1%205%202s-5.5.5-5-2z%22%20fill=%22%23efb07a%22%20fill-opacity=%220.45%22/%3E%20%3Cpath%20d=%22M22%2014c2%200%203%202%202%203.5M28%2011c1.5.5%202.5%202%201.5%203.5%22%20stroke=%22%23ede9fe%22%20stroke-width=%220.95%22%20opacity=%220.95%22/%3E%20%3Ccircle%20cx=%2222%22%20cy=%2214%22%20r=%221.85%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2214%22%20cy=%2224%22%20r=%221.35%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%2230%22%20cy=%2211%22%20r=%221.15%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2240%22%20cy=%2210%22%20r=%220.95%22%20fill=%22%23a78bfa%22/%3E%20%3Ccircle%20cx=%2212%22%20cy=%2234%22%20r=%220.95%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%2218%22%20cy=%2242%22%20r=%220.75%22%20fill=%22%23efd9a0%22/%3E%20%3Ccircle%20cx=%2226%22%20cy=%2218%22%20r=%220.65%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2234%22%20cy=%2215%22%20r=%220.55%22%20fill=%22%23a78bfa%22%20opacity=%220.9%22/%3E%3C/svg%3E\");\n  --raiden-gold-corner-tr: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2264%22%20height=%2264%22%20viewBox=%220%200%2064%2064%22%20fill=%22none%22%3E%3Cg%20transform=%22translate(64%200)%20scale(-1%201)%22%3E%3Cpath%20d=%22M8%2054V14c0-5%204-9%209-9h38%22%20stroke=%22%23efb07a%22%20stroke-width=%222%22%20stroke-linecap=%22round%22/%3E%20%3Cpath%20d=%22M8%2054V20%22%20stroke=%22%23a78bfa%22%20stroke-width=%221.15%22%20opacity=%220.85%22/%3E%20%3Cpath%20d=%22M18%2020c7-9%2016-12%2028-8%22%20stroke=%22%23efd9a0%22%20stroke-width=%221.25%22%20opacity=%220.95%22/%3E%20%3Cpath%20d=%22M16%2028c4-8%2011-11%2020-8%22%20stroke=%22%23c4b5fd%22%20stroke-width=%221%22%20opacity=%220.8%22/%3E%20%3Cpath%20d=%22M14%2036c3-3%206-1%205%202s-5.5.5-5-2z%22%20fill=%22%23efb07a%22%20fill-opacity=%220.45%22/%3E%20%3Cpath%20d=%22M22%2014c2%200%203%202%202%203.5M28%2011c1.5.5%202.5%202%201.5%203.5%22%20stroke=%22%23ede9fe%22%20stroke-width=%220.95%22%20opacity=%220.95%22/%3E%20%3Ccircle%20cx=%2222%22%20cy=%2214%22%20r=%221.85%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2214%22%20cy=%2224%22%20r=%221.35%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%2230%22%20cy=%2211%22%20r=%221.15%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2240%22%20cy=%2210%22%20r=%220.95%22%20fill=%22%23a78bfa%22/%3E%20%3Ccircle%20cx=%2212%22%20cy=%2234%22%20r=%220.95%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%2218%22%20cy=%2242%22%20r=%220.75%22%20fill=%22%23efd9a0%22/%3E%20%3Ccircle%20cx=%2226%22%20cy=%2218%22%20r=%220.65%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2234%22%20cy=%2215%22%20r=%220.55%22%20fill=%22%23a78bfa%22%20opacity=%220.9%22/%3E%3C/g%3E%3C/svg%3E\");\n  --raiden-gold-corner-bl: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2264%22%20height=%2264%22%20viewBox=%220%200%2064%2064%22%20fill=%22none%22%3E%3Cg%20transform=%22translate(0%2064)%20scale(1%20-1)%22%3E%3Cpath%20d=%22M8%2054V14c0-5%204-9%209-9h38%22%20stroke=%22%23efb07a%22%20stroke-width=%222%22%20stroke-linecap=%22round%22/%3E%20%3Cpath%20d=%22M8%2054V20%22%20stroke=%22%23a78bfa%22%20stroke-width=%221.15%22%20opacity=%220.85%22/%3E%20%3Cpath%20d=%22M18%2020c7-9%2016-12%2028-8%22%20stroke=%22%23efd9a0%22%20stroke-width=%221.25%22%20opacity=%220.95%22/%3E%20%3Cpath%20d=%22M16%2028c4-8%2011-11%2020-8%22%20stroke=%22%23c4b5fd%22%20stroke-width=%221%22%20opacity=%220.8%22/%3E%20%3Cpath%20d=%22M14%2036c3-3%206-1%205%202s-5.5.5-5-2z%22%20fill=%22%23efb07a%22%20fill-opacity=%220.45%22/%3E%20%3Cpath%20d=%22M22%2014c2%200%203%202%202%203.5M28%2011c1.5.5%202.5%202%201.5%203.5%22%20stroke=%22%23ede9fe%22%20stroke-width=%220.95%22%20opacity=%220.95%22/%3E%20%3Ccircle%20cx=%2222%22%20cy=%2214%22%20r=%221.85%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2214%22%20cy=%2224%22%20r=%221.35%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%2230%22%20cy=%2211%22%20r=%221.15%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2240%22%20cy=%2210%22%20r=%220.95%22%20fill=%22%23a78bfa%22/%3E%20%3Ccircle%20cx=%2212%22%20cy=%2234%22%20r=%220.95%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%2218%22%20cy=%2242%22%20r=%220.75%22%20fill=%22%23efd9a0%22/%3E%20%3Ccircle%20cx=%2226%22%20cy=%2218%22%20r=%220.65%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2234%22%20cy=%2215%22%20r=%220.55%22%20fill=%22%23a78bfa%22%20opacity=%220.9%22/%3E%3C/g%3E%3C/svg%3E\");\n  --raiden-gold-corner-br: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2264%22%20height=%2264%22%20viewBox=%220%200%2064%2064%22%20fill=%22none%22%3E%3Cg%20transform=%22translate(64%2064)%20scale(-1%20-1)%22%3E%3Cpath%20d=%22M8%2054V14c0-5%204-9%209-9h38%22%20stroke=%22%23efb07a%22%20stroke-width=%222%22%20stroke-linecap=%22round%22/%3E%20%3Cpath%20d=%22M8%2054V20%22%20stroke=%22%23a78bfa%22%20stroke-width=%221.15%22%20opacity=%220.85%22/%3E%20%3Cpath%20d=%22M18%2020c7-9%2016-12%2028-8%22%20stroke=%22%23efd9a0%22%20stroke-width=%221.25%22%20opacity=%220.95%22/%3E%20%3Cpath%20d=%22M16%2028c4-8%2011-11%2020-8%22%20stroke=%22%23c4b5fd%22%20stroke-width=%221%22%20opacity=%220.8%22/%3E%20%3Cpath%20d=%22M14%2036c3-3%206-1%205%202s-5.5.5-5-2z%22%20fill=%22%23efb07a%22%20fill-opacity=%220.45%22/%3E%20%3Cpath%20d=%22M22%2014c2%200%203%202%202%203.5M28%2011c1.5.5%202.5%202%201.5%203.5%22%20stroke=%22%23ede9fe%22%20stroke-width=%220.95%22%20opacity=%220.95%22/%3E%20%3Ccircle%20cx=%2222%22%20cy=%2214%22%20r=%221.85%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2214%22%20cy=%2224%22%20r=%221.35%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%2230%22%20cy=%2211%22%20r=%221.15%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2240%22%20cy=%2210%22%20r=%220.95%22%20fill=%22%23a78bfa%22/%3E%20%3Ccircle%20cx=%2212%22%20cy=%2234%22%20r=%220.95%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%2218%22%20cy=%2242%22%20r=%220.75%22%20fill=%22%23efd9a0%22/%3E%20%3Ccircle%20cx=%2226%22%20cy=%2218%22%20r=%220.65%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2234%22%20cy=%2215%22%20r=%220.55%22%20fill=%22%23a78bfa%22%20opacity=%220.9%22/%3E%3C/g%3E%3C/svg%3E\");\n  --raiden-gold-dust-bar: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%22180%22%20height=%2218%22%20viewBox=%220%200%20180%2018%22%20fill=%22none%22%3E%20%3Cpath%20d=%22M2%209c12-5%2024%205%2036%200s24-5%2036%200%2024%205%2036%200%2024-5%2036%200%2024%205%2036%200%22%20stroke=%22%23efb07a%22%20stroke-width=%221.4%22%20opacity=%220.95%22/%3E%20%3Cpath%20d=%22M8%209c10%204%2020-4%2030%200s20%204%2030%200%2020-4%2030%200%2020%204%2030%200%22%20stroke=%22%23a78bfa%22%20stroke-width=%221%22%20opacity=%220.82%22/%3E%20%3Cpath%20d=%22M20%209c6-3%2012%203%2018%200s12-3%2018%200%22%20stroke=%22%23ede9fe%22%20stroke-width=%220.8%22%20opacity=%220.9%22/%3E%20%3Ccircle%20cx=%2216%22%20cy=%223.2%22%20r=%221.4%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2244%22%20cy=%2214.2%22%20r=%221.15%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%2272%22%20cy=%223.6%22%20r=%221.5%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%22100%22%20cy=%2213.8%22%20r=%221.2%22%20fill=%22%23a78bfa%22/%3E%20%3Ccircle%20cx=%22128%22%20cy=%223.4%22%20r=%221.25%22%20fill=%22%23efb07a%22/%3E%20%3Ccircle%20cx=%22156%22%20cy=%2213.5%22%20r=%221.1%22%20fill=%22%23c4b5fd%22/%3E%20%3Ccircle%20cx=%2230%22%20cy=%229%22%20r=%220.8%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2286%22%20cy=%228.5%22%20r=%220.85%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%22142%22%20cy=%229.2%22%20r=%220.75%22%20fill=%22%23efd9a0%22/%3E%20%3Ccircle%20cx=%2258%22%20cy=%226%22%20r=%220.6%22%20fill=%22%23ddd6fe%22/%3E%20%3Ccircle%20cx=%22114%22%20cy=%2211%22%20r=%220.6%22%20fill=%22%23a78bfa%22/%3E%20%3C/svg%3E\");\n  --raiden-gold-bow-art: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2248%22%20height=%2220%22%20viewBox=%220%200%2048%2020%22%20fill=%22none%22%3E%20%3Cpath%20d=%22M24%2010c-4-5-10-6-14-3%204%201%207%204%208%207%201-3%204-6%208-7-4-3-10-2-14%203z%22%20fill=%22%23a78bfa%22%20opacity=%220.88%22/%3E%20%3Cpath%20d=%22M24%2010c4-5%2010-6%2014-3-4%201-7%204-8%207-1-3-4-6-8-7%204-3%2010-2%2014%203z%22%20fill=%22%23efb07a%22%20opacity=%220.9%22/%3E%20%3Ccircle%20cx=%2224%22%20cy=%2210%22%20r=%222.2%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%2224%22%20cy=%2210%22%20r=%221.1%22%20fill=%22%23c4b5fd%22/%3E%20%3C/svg%3E\");\n  --raiden-gold-jewel-art: url(\"data:image/svg+xml,%3Csvg%20xmlns=%22http://www.w3.org/2000/svg%22%20width=%2218%22%20height=%2218%22%20viewBox=%220%200%2018%2018%22%20fill=%22none%22%3E%20%3Cpath%20d=%22M9%202.2%2014.2%209%209%2015.8%203.8%209Z%22%20fill=%22%23c4b5fd%22%20opacity=%220.9%22/%3E%20%3Cpath%20d=%22M9%204.2%2012.4%209%209%2013.8%205.6%209Z%22%20fill=%22%23ede9fe%22/%3E%20%3Ccircle%20cx=%229%22%20cy=%229%22%20r=%221.3%22%20fill=%22%23efb07a%22/%3E%20%3C/svg%3E\");\n  --raiden-gold-dust-edge:\nradial-gradient(circle at 8% 0%, rgba(167, 139, 250, 1) 0 1.4px, transparent 2px),\n    radial-gradient(circle at 18% 0%, rgba(237, 233, 254, 0.95) 0 1px, transparent 1.6px),\n    radial-gradient(circle at 32% 0%, rgba(239, 176, 122, 0.95) 0 1.3px, transparent 1.9px),\n    radial-gradient(circle at 48% 0%, rgba(167, 139, 250, 0.92) 0 1.1px, transparent 1.7px),\n    radial-gradient(circle at 64% 0%, rgba(239, 176, 122, 0.95) 0 1.35px, transparent 1.95px),\n    radial-gradient(circle at 78% 0%, rgba(221, 214, 254, 0.9) 0 1px, transparent 1.6px),\n    radial-gradient(circle at 90% 0%, rgba(167, 139, 250, 0.95) 0 1.25px, transparent 1.85px),\n    radial-gradient(circle at 100% 12%, rgba(239, 176, 122, 0.95) 0 1.3px, transparent 1.9px),\n    radial-gradient(circle at 100% 28%, rgba(237, 233, 254, 0.88) 0 1px, transparent 1.6px),\n    radial-gradient(circle at 100% 48%, rgba(167, 139, 250, 0.92) 0 1.2px, transparent 1.8px),\n    radial-gradient(circle at 100% 68%, rgba(245, 196, 168, 0.88) 0 1.05px, transparent 1.65px),\n    radial-gradient(circle at 100% 86%, rgba(167, 139, 250, 0.92) 0 1.25px, transparent 1.85px),\n    radial-gradient(circle at 92% 100%, rgba(239, 176, 122, 0.95) 0 1.35px, transparent 1.95px),\n    radial-gradient(circle at 74% 100%, rgba(237, 233, 254, 0.9) 0 1px, transparent 1.6px),\n    radial-gradient(circle at 52% 100%, rgba(167, 139, 250, 0.95) 0 1.3px, transparent 1.9px),\n    radial-gradient(circle at 30% 100%, rgba(245, 196, 168, 0.9) 0 1.1px, transparent 1.7px),\n    radial-gradient(circle at 12% 100%, rgba(167, 139, 250, 0.95) 0 1.25px, transparent 1.85px),\n    radial-gradient(circle at 0% 82%, rgba(239, 176, 122, 0.92) 0 1.2px, transparent 1.8px),\n    radial-gradient(circle at 0% 58%, rgba(221, 214, 254, 0.88) 0 1px, transparent 1.6px),\n    radial-gradient(circle at 0% 34%, rgba(167, 139, 250, 0.92) 0 1.25px, transparent 1.85px),\n    radial-gradient(circle at 0% 14%, rgba(239, 176, 122, 0.9) 0 1.05px, transparent 1.65px);\n  --raiden-character-opacity: 1;\n  --raiden-veil-opacity: var(--raiden-veil-strength);\n  --raiden-acrylic-percent: 38;\n  --raiden-conversation-left: 0px;\n  --raiden-conversation-top: 0px;\n  --raiden-conversation-width: 0px;\n  --raiden-conversation-height: 0px;\n  --raiden-conversation-content-left: 0px;\n  --raiden-conversation-content-width: 0px;\n  --raiden-conversation-viewport-top: 0px;\n  --raiden-conversation-viewport-height: 0px;\n  --raiden-content-left: 0px;\n  --raiden-content-width: 0px;\n  --raiden-viewport-top: 0px;\n  --raiden-viewport-height: 0px;\n  --raiden-composer-top: 0px;\n  --raiden-composer-height: 0px;\n  --raiden-acrylic-bg: color-mix(in srgb, rgb(244, 238, 252) calc(var(--raiden-acrylic-percent) * 1%), transparent);\n  --raiden-acrylic-bg-strong: color-mix(in srgb, rgb(237, 228, 252) calc((var(--raiden-acrylic-percent) + 12) * 1%), transparent);\n  --raiden-acrylic-bg-soft: color-mix(in srgb, rgb(244, 238, 252) calc((var(--raiden-acrylic-percent) - 15) * 1%), transparent);\n  --raiden-acrylic-border: rgba(124, 58, 237, 0.22);\n  --raiden-acrylic-hairline: rgba(167, 139, 250, 0.28);\n  --raiden-acrylic-shadow: rgba(61, 24, 92, 0.12);\n  --raiden-acrylic-blur: 18px;\n  --raiden-acrylic-saturation: 1.12;\n  --raiden-acrylic-light: color-mix(in srgb, rgb(244, 238, 252) calc(var(--raiden-panel-opacity) * 1%), transparent);\n  --raiden-acrylic-dark: color-mix(in srgb, rgb(22, 12, 38) calc(var(--raiden-panel-opacity) * 1%), transparent);\n  --raiden-border-light: rgba(124, 58, 237, 0.28);\n  --raiden-border-dark: rgba(196, 181, 253, 0.22);\n  --raiden-highlight: rgba(255, 255, 255, 0.42);\n  --raiden-shadow: 0 12px 32px rgba(61, 24, 92, 0.14);\n\n  background-color: transparent;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-preset='raiden-sakura'] {\n  --ds-raiden-cream: #f6fbfc;\n  --ds-raiden-cream-deep: #e8f4f6;\n  --raiden-accent: var(--ds-raiden-lens);\n  --raiden-glow: rgba(145, 213, 232, 0.28);\n  --raiden-veil: #f6fbfc;\n}\n\nbody[data-dsh-raiden-theme][data-ds-dark-theme],\nbody[data-dsh-raiden-theme][data-raiden-preset='raiden-night'] {\n  --ds-raiden-cream: #160e24;\n  --ds-raiden-cream-deep: #0f0818;\n  --ds-raiden-text: #f4edff;\n  --ds-raiden-text-on-dark: #f4edff;\n  --raiden-text-halo:\n    0 0 0.8px rgba(244, 237, 255, 0.95),\n    0 0 8px rgba(167, 139, 250, 0.4),\n    0 0 16px rgba(124, 58, 237, 0.28);\n  --raiden-veil: #160e24;\n  --raiden-veil-strength: 0.08;\n  --raiden-veil-opacity: var(--raiden-veil-strength);\n  --raiden-panel-opacity: 42;\n  --raiden-glow: rgba(167, 139, 250, 0.28);\n  --raiden-plate-art: linear-gradient(\n    90deg,\n    rgba(109, 40, 217, 0.28),\n    rgba(22, 14, 36, 0.32) 50%,\n    rgba(167, 139, 250, 0.22)\n  );\n  --raiden-settings-frame-art: var(--raiden-plate-art);\n  --raiden-acrylic-bg: color-mix(in srgb, rgb(22, 14, 36) calc(var(--raiden-acrylic-percent) * 1%), transparent);\n  --raiden-acrylic-bg-strong: color-mix(in srgb, rgb(22, 14, 36) calc((var(--raiden-acrylic-percent) + 10) * 1%), transparent);\n  --raiden-acrylic-bg-soft: color-mix(in srgb, rgb(22, 14, 36) calc((var(--raiden-acrylic-percent) - 18) * 1%), transparent);\n  --raiden-acrylic-dark: color-mix(in srgb, rgb(22, 14, 36) calc(var(--raiden-panel-opacity) * 1%), transparent);\n  --raiden-acrylic-border: rgba(196, 181, 253, 0.18);\n  --raiden-acrylic-hairline: rgba(167, 139, 250, 0.28);\n  --raiden-acrylic-shadow: rgba(0, 0, 0, 0.28);\n  --raiden-acrylic-blur: 18px;\n  --raiden-acrylic-saturation: 1.14;\n  --raiden-muted: #b5a4c9;\n  background-color: transparent;\n}\n\nbody[data-dsh-raiden-theme] :is(\n  [class*='sidebarCol'],\n  [class*='centerCol'],\n  [class*='detailsCol'],\n  [data-pane='conversation'],\n  [data-pane='sidebar']\n) {\n  --dsw-alias-bg-base: transparent;\n  --dsw-alias-bg-layer-1: color-mix(in srgb, var(--ds-raiden-cream) 22%, transparent);\n  --dsw-alias-bg-layer-2: color-mix(in srgb, #fffdfb 28%, transparent);\n  --dsw-alias-bg-layer-3: color-mix(in srgb, var(--ds-raiden-cream-deep) 36%, transparent);\n  --dsw-alias-bg-overlay: color-mix(in srgb, var(--ds-raiden-cream) 28%, transparent);\n  --dsw-alias-border-l1: rgba(73, 59, 80, 0.08);\n  --dsw-alias-border-l2: rgba(73, 59, 80, 0.14);\n  --dsw-alias-border-l2-darkmode-thin: rgba(73, 59, 80, 0.12);\n  --dsw-alias-border-l3: color-mix(in srgb, var(--ds-raiden-pink) 42%, transparent);\n  --dsw-alias-brand-primary: var(--ds-raiden-pink);\n  --dsw-alias-brand-text: var(--ds-raiden-text);\n  --dsw-alias-button-info-fill: var(--ds-raiden-pink);\n  --dsw-alias-button-info-hover: var(--ds-raiden-pink-soft);\n  --dsw-alias-label-caption: #6d5d74;\n  --dsw-alias-label-dimmed: #8a7a90;\n  --dsw-alias-label-primary-bluish: var(--ds-raiden-text);\n  --dsw-alias-label-primary-dimmed: #5c4c62;\n  --dsw-alias-label-primary-foreground: #fff7f1;\n  --dsw-alias-label-primary-inverted: #fff7f1;\n  --dsw-alias-label-primary: var(--ds-raiden-text);\n  --dsw-alias-label-secondary: #74697b;\n  --dsw-alias-label-tertiary: #948a99;\n  --dsw-alias-interactive-bg-hover: rgba(167, 139, 250, 0.14);\n  --dsw-alias-interactive-bg-active: rgba(124, 58, 237, 0.16);\n  --dsw-specific-bubble: #f3eaff;\n  --dsw-specific-bubble-highlight: #e9dcff;\n  --dsw-specific-sidebar-fill: color-mix(in srgb, #d9c8f6 38%, transparent);\n  --dsw-specific-input-major: color-mix(in srgb, #f4eefc 52%, transparent);\n  color: var(--ds-raiden-text);\n  font-family: var(--raiden-font);\n}\n\nbody[data-dsh-raiden-theme][data-ds-dark-theme] :is(\n  [class*='sidebarCol'],\n  [class*='centerCol'],\n  [class*='detailsCol'],\n  [data-pane='conversation'],\n  [data-pane='sidebar']\n),\nbody[data-dsh-raiden-theme][data-raiden-preset='raiden-night'] :is(\n  [class*='sidebarCol'],\n  [class*='centerCol'],\n  [class*='detailsCol'],\n  [data-pane='conversation'],\n  [data-pane='sidebar']\n) {\n  --dsw-alias-bg-layer-1: color-mix(in srgb, #2a2340 22%, transparent);\n  --dsw-alias-bg-layer-2: color-mix(in srgb, #2a2340 28%, transparent);\n  --dsw-alias-bg-layer-3: color-mix(in srgb, #181326 32%, transparent);\n  --dsw-alias-bg-overlay: color-mix(in srgb, #181326 28%, transparent);\n  --dsw-alias-border-l1: rgba(167, 139, 250, 0.14);\n  --dsw-alias-border-l2: rgba(167, 139, 250, 0.22);\n  --dsw-alias-border-l3: color-mix(in srgb, var(--ds-raiden-pink) 46%, transparent);\n  --dsw-alias-brand-primary: var(--ds-raiden-pink-soft);\n  --dsw-alias-brand-text: var(--ds-raiden-text);\n  --dsw-alias-label-caption: #d8ccec;\n  --dsw-alias-label-dimmed: #c4b5d9;\n  --dsw-alias-label-primary-bluish: var(--ds-raiden-text);\n  --dsw-alias-label-primary-dimmed: #efe6ff;\n  --dsw-alias-label-primary-foreground: #160e24;\n  --dsw-alias-label-primary-inverted: #160e24;\n  --dsw-alias-label-primary: var(--ds-raiden-text);\n  --dsw-alias-label-secondary: #d8ccec;\n  --dsw-alias-label-tertiary: #b5a4c9;\n  --dsw-specific-bubble: #221536;\n  --dsw-specific-bubble-highlight: #2c1c44;\n  --dsw-specific-sidebar-fill: color-mix(in srgb, #1a102c 42%, transparent);\n  --dsw-specific-input-major: color-mix(in srgb, #1c1230 48%, transparent);\n  color: var(--ds-raiden-text);\n}\n\nbody[data-dsh-raiden-theme] [class*='centerCol'] {\n  --dsw-alias-bg-base: transparent;\n  --dsw-alias-bg-layer-1: color-mix(in srgb, var(--ds-raiden-cream) 12%, transparent);\n  --dsw-alias-bg-layer-2: color-mix(in srgb, #fffdfb 14%, transparent);\n  --dsw-alias-bg-layer-3: color-mix(in srgb, var(--ds-raiden-cream-deep) 16%, transparent);\n  --dsw-alias-bg-overlay: color-mix(in srgb, var(--ds-raiden-cream) 18%, transparent);\n}\n\n/* AppFrame.frame paints --dsw-alias-bg-base. Keep that token transparent so\n   column translucency reveals the wallpaper instead of the host shell. */\nbody[data-dsh-raiden-theme] [id='root'] div:has(> [class*='sidebarCol']):has(> [class*='centerCol']) {\n  --dsw-alias-bg-base: transparent;\n}\n\nbody[data-dsh-raiden-theme][data-ds-dark-theme] [class*='centerCol'],\nbody[data-dsh-raiden-theme][data-raiden-preset='raiden-night'] [class*='centerCol'] {\n  --dsw-alias-bg-layer-1: color-mix(in srgb, #2a2340 12%, transparent);\n  --dsw-alias-bg-layer-2: color-mix(in srgb, #2a2340 14%, transparent);\n  --dsw-alias-bg-layer-3: color-mix(in srgb, #181326 16%, transparent);\n  --dsw-alias-bg-overlay: color-mix(in srgb, #181326 18%, transparent);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='idle'] {\n  --raiden-accent: var(--ds-agent-idle);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='thinking'] {\n  --raiden-accent: var(--ds-agent-thinking);\n  --raiden-glow: rgba(185, 167, 232, 0.3);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='tool-calling'] {\n  --raiden-accent: var(--ds-agent-tool);\n  --raiden-glow: rgba(145, 213, 232, 0.3);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='streaming'] {\n  --raiden-accent: var(--ds-agent-streaming);\n  --raiden-glow: rgba(167, 139, 250, 0.3);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='success'] {\n  --raiden-accent: var(--ds-agent-success);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-state='error'] {\n  --raiden-accent: var(--ds-agent-error);\n  --raiden-glow: rgba(196, 60, 60, 0.3);\n}\n\nbody[data-dsh-raiden-theme][data-raiden-veil='thin'] {\n  --raiden-veil-strength: 0.08;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-veil='standard'] {\n  --raiden-veil-strength: 0.12;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-veil='thick'] {\n  --raiden-veil-strength: 0.18;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-frame-opacity='70'] {\n  --raiden-frame-opacity: 0.7;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-frame-opacity='85'] {\n  --raiden-frame-opacity: 0.85;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-frame-opacity='100'] {\n  --raiden-frame-opacity: 1;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-panel-opacity='55'] {\n  --raiden-panel-opacity: 55;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-panel-opacity='70'] {\n  --raiden-panel-opacity: 70;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-panel-opacity='85'] {\n  --raiden-panel-opacity: 85;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-panel-opacity='92'] {\n  --raiden-panel-opacity: 92;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-character-opacity='70'] {\n  --raiden-character-opacity: 0.7;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-character-opacity='85'] {\n  --raiden-character-opacity: 0.85;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-character-opacity='100'] {\n  --raiden-character-opacity: 1;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-acrylic-percent='50'] {\n  --raiden-acrylic-percent: 50;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-acrylic-percent='70'] {\n  --raiden-acrylic-percent: 70;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-acrylic-percent='85'] {\n  --raiden-acrylic-percent: 85;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-acrylic-percent='92'] {\n  --raiden-acrylic-percent: 92;\n}\n\nbody[data-dsh-raiden-theme][data-dsh-raiden-intensity='low'] {\n  --raiden-motion-scale: 0.6;\n  --raiden-motion-duration: 1.4;\n}\n\nbody[data-dsh-raiden-theme][data-dsh-raiden-intensity='high'] {\n  --raiden-motion-scale: 1.2;\n  --raiden-motion-duration: 0.8;\n}\n\nbody[data-dsh-raiden-theme][data-dsh-raiden-motion='off'],\nbody[data-dsh-raiden-theme][data-dsh-raiden-reduced-motion='true'] {\n  --raiden-motion-scale: 0;\n}\n\nbody[data-dsh-raiden-theme][data-raiden-low-power] {\n  --raiden-acrylic-blur: 0px;\n  --raiden-motion-scale: 0;\n}\n";
		...
		const ASSET_SET_VERSION = "2026-08-26-raiden-v17";
		...
		const BUNDLED_Q_SETTINGS = buildAssetUrl("hero-avatar.webp");
		...
		const BUNDLED_ARCHIVE_GIF = buildAssetUrl("icons/archive-q-light.webp");
		const BUNDLED_ARCHIVE_STILL = buildAssetUrl("icons/archive-q-light-still.webp");
		const BUNDLED_ARCHIVE_GIF_DARK = buildAssetUrl("icons/archive-q-dark.webp");
		const BUNDLED_ARCHIVE_STILL_DARK = buildAssetUrl("icons/archive-q-dark-still.webp");
		//#endregion
		...
		function syncStageArt(root = document.body, settings) {
			...
			if (workspaceMascot instanceof HTMLImageElement && settings?.showWorkspaceMascot) {
				const reduced = Boolean(settings?.reducedMotion) || typeof window !== "undefined" && typeof window.matchMedia === "function" && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
				applyImageSrc(workspaceMascot, night ? reduced ? BUNDLED_ARCHIVE_STILL_DARK : BUNDLED_ARCHIVE_GIF_DARK : reduced ? BUNDLED_ARCHIVE_STILL : BUNDLED_ARCHIVE_GIF);
			}
		}
		...
		function findWorkspaceHost(sidebar) {
			...
			const search = sidebar.querySelector("button[aria-label=\"搜索会话\"], button[aria-label=\"Search sessions\"]");
			if (search instanceof HTMLElement) {
				const root = search.closest("[class*=\"sectionHeader\"]")?.parentElement;
				if (root instanceof HTMLElement) return root;
			}
			return null;
		}
		function decorateSidebar(settings, sidebar) {
			...
			const reduced = settings.reducedMotion || typeof window !== "undefined" && typeof window.matchMedia === "function" && window.matchMedia("(prefers-reduced-motion: reduce)").matches;
			const src = isNightScene() ? reduced ? BUNDLED_ARCHIVE_STILL_DARK : BUNDLED_ARCHIVE_GIF_DARK : reduced ? BUNDLED_ARCHIVE_STILL : BUNDLED_ARCHIVE_GIF;
			applyImageSrc(gif, src);
			return [gif];
		}
		function syncSidebarMascot(settings, root = document) {
		...
		const RAIDEN_INLINE_STYLE_KEYS = [
			...Q_VARS,
			...OPACITY_VARS,
		...
		*/
		...
		const HOST_HEADLINES = /* @__PURE__ */ new Set([
			"探索未至之境",
			"Into the Unknown",
			"雷电将军 · 尘世七执政 · 永恒"
		]);
		const RAIDEN_HERO_HEADLINE = "原神！！！启动！！！";
		/**
		* 0.1.5-rc.1 起官方删了 headlineText 类名，标题是标题组里的裸 span。
		* 用 hero 容器定位：先找 [data-phase='hero']，其下标题组第一个纯文本 span。
		*/
		const HERO_SCOPE_SELECTOR = "[data-phase='hero']";
		const DEFAULT_HERO_HEADLINE = RAIDEN_HERO_HEADLINE;
		function resolveHeroHeadline(settings) {
			return settings?.heroHeadline?.trim() || "原神！！！启动！！！";
		}
		function isHeadlineCandidate(node) {
			if (node.childElementCount > 0) return false;
			return node.textContent !== null && node.textContent.trim().length > 0;
		}
		function collectHeadlineNodes(root) {
			const out = [];
			const scopes = root instanceof HTMLElement && root.matches("[data-phase='hero']") ? [root] : Array.from(root.querySelectorAll(HERO_SCOPE_SELECTOR));
			for (const scope of scopes) {
				if (!(scope instanceof HTMLElement)) continue;
				const groups = scope.querySelectorAll("span");
				for (const node of groups) if (node instanceof HTMLElement && isHeadlineCandidate(node)) out.push(node);
			}
			return out;
		}
		...
		function touchesHeroCopy(node) {
			if (!(node instanceof Element)) return false;
			return node.matches("[data-phase='hero']") || node.closest("[data-phase='hero']") !== null || node.querySelector("[data-phase='hero']") !== null;
		}
		//#endregion
		...
		function createChromeObserver(options) {
			...
			const maybeDecorateSidebar = () => {
				...
				for (const node of previous) if (!nodes.includes(node)) node.remove();
			...
			const observer = new MutationObserver((mutations) => {
				...
				for (const mutation of mutations) {
					if (mutation.type === "characterData") {
						...
						if (parent instanceof Element && parent.closest("[data-phase='hero']")) heroSync.schedule();
						continue;
					}
					if (mutation.type === "childList") {
						if (mutation.target instanceof Element && mutation.target.closest("[data-phase='hero']")) heroSync.schedule();
		...
		function TextField({ label, value, placeholder, onChange }) {
			return (0, react.createElement)("label", { className: "dsh-raiden-text-row" }, (0, react.createElement)("span", { className: "dsh-raiden-slider-head" }, (0, react.createElement)("span", null, label)), (0, react.createElement)("input", {
				type: "text",
				value,
				placeholder,
		...
		function RaidenModeRow() {
			...
			}), (0, react.createElement)("div", { className: "dsh-raiden-general-title" }, "个性化"), (0, react.createElement)(TextField, {
				label: "标题文案",
				value: settings.heroHeadline,
				placeholder: RAIDEN_HERO_HEADLINE,
				onChange: (heroHeadline) => commit({ heroHeadline: heroHeadline.trim() || "原神！！！启动！！！" })
			...
			}), (0, react.createElement)("div", { className: "dsh-raiden-general-title" }, "工作区 Q 版动图"), (0, react.createElement)("div", { className: "dsh-raiden-general-cubes" }, (0, react.createElement)(Cube, {
				selected: settings.showWorkspaceMascot,
				label: "开启",
				onClick: () => commit({ showWorkspaceMascot: true })
			}), (0, react.createElement)(Cube, {
				selected: !settings.showWorkspaceMascot,
				label: "关闭",
				onClick: () => commit({ showWorkspaceMascot: false })
			...
			})), (0, react.createElement)("div", { className: "dsh-raiden-general-note" }, "紫金工房：浅色花房、深色雷舞台跟着「外观」走。面板尽量透明，贴进背景。想听雷电将军说话，去 Agent 预设里选「Raiden 雷电将军」。"));
		}
		...
		function apply(ctx) {
			...
			const mountStaticChrome = () => {
				...
				const chrome = createChromeObserver({ getSettings: () => settings });
