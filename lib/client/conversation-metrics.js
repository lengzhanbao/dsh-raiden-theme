...
export function writeConversationMetrics(body, rects) {
    ...
    body.style.setProperty('--raiden-conversation-left', `${Math.round(rects.shell.left)}px`);
    body.style.setProperty('--raiden-conversation-top', `${Math.round(rects.shell.top)}px`);
    body.style.setProperty('--raiden-conversation-width', `${Math.round(rects.shell.width)}px`);
    body.style.setProperty('--raiden-conversation-height', `${Math.round(rects.shell.height)}px`);
    body.style.setProperty('--raiden-conversation-content-left', `${Math.round(rects.content.left)}px`);
    body.style.setProperty('--raiden-conversation-content-width', `${Math.round(rects.content.width)}px`);
    body.style.setProperty('--raiden-conversation-viewport-top', `${Math.round(rects.viewport.top)}px`);
    body.style.setProperty('--raiden-conversation-viewport-height', `${Math.round(rects.viewport.height)}px`);
    body.style.setProperty('--raiden-content-left', `${Math.round(rects.content.left)}px`);
    body.style.setProperty('--raiden-content-width', `${Math.round(rects.content.width)}px`);
    body.style.setProperty('--raiden-viewport-top', `${Math.round(rects.viewport.top)}px`);
    body.style.setProperty('--raiden-viewport-height', `${Math.round(rects.viewport.height)}px`);
    const frame = computeFrameBox(rects);
    body.style.setProperty('--raiden-frame-left', `${frame.left}px`);
    body.style.setProperty('--raiden-frame-top', `${frame.top}px`);
    body.style.setProperty('--raiden-frame-width', `${frame.width}px`);
    body.style.setProperty('--raiden-frame-height', `${frame.height}px`);
    ...
    const composerHeight = rects.composer && rects.composer.height > 24
        ...
        : 0;
    body.style.setProperty('--raiden-composer-top', `${composerTop}px`);
    body.style.setProperty('--raiden-composer-height', `${composerHeight}px`);
    ...
    const fromContent = rects.content.width > 40
        ...
        : 0;
    body.style.setProperty('--raiden-frame-right-inset', `${fromContent}px`);
    body.toggleAttribute('data-raiden-frame-hidden', hidden);
    body.toggleAttribute('data-raiden-frame-compact', !hidden && rects.content.width < FRAME_COMPACT_WIDTH);
}
