# Link local dsh-raiden-theme into the DSH web profile (3080) for dev verification.
...
Write-Host "Rollback: dsh plugin --profile web add https://github.com/lengzhanbao/dsh-raiden-theme/releases/latest/download/dsh-external-dsh-raiden-theme-0.1.0.tgz"
