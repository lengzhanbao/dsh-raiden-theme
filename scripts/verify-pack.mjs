...
const REQUIRED = [
  ...
  'package/lib/prompt/raiden-system.md',
  'package/cordis.patch.yml',
  'package/skin.json',
  'package/assets/raiden/wallpaper-light.webp',
  'package/assets/raiden/avatar.webp',
]
...
const work = mkdtempSync(join(tmpdir(), 'raiden-pack-'))
